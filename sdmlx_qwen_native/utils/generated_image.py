...
from sdmlx_qwen_native.utils.version_util import VersionUtil
...
class GeneratedImage:
    ...
    def _get_metadata(self) -> dict:
        metadata = {
            "sdmlx_qwen_native_version": VersionUtil.get_sdmlx_qwen_native_version(),
