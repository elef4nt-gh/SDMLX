        ...
        try:
            with PIL.Image.open(image_path) as img:
                ...
                fields = {
                    ...
                    "seed": "<sdmlx_qwen_native:seed>",
                    "steps": "<sdmlx_qwen_native:steps>",
                    "guidance": "<sdmlx_qwen_native:guidance>",
                    "model": "<sdmlx_qwen_native:model>",
                    "loras": "<sdmlx_qwen_native:loras>",
                    "generation_time": "<sdmlx_qwen_native:generationTime>",
                }
