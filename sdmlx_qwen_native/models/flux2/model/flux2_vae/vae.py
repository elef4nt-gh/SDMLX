...
from sdmlx_qwen_native.models.flux2.model.flux2_vae.encoder.encoder import Flux2Encoder
...
class Flux2VAE(nn.Module):
    ...
    def __init__(self, decoder_block_out_channels: tuple[int, ...] | None = None):
        super().__init__()
        self.encoder = Flux2Encoder()
        self.decoder = Flux2Decoder(block_out_channels=decoder_block_out_channels or (128, 256, 512, 512))
