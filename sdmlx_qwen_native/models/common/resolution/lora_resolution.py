...
from sdmlx_qwen_native.cli.defaults.defaults import MFLUX_LORA_CACHE_DIR
from sdmlx_qwen_native.models.common.resolution.actions import LoraAction, Rule
...
class LoraResolution:
    ...
    def _load_collection_from_cache(repo_id: str, filename: str) -> str:
        ...
        # Check sdmlx_qwen_native cache first
        cached_file_path = cache_path / filename
        if cached_file_path.exists() and cached_file_path.is_file():
            try:
