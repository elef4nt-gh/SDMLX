...
from sdmlx_qwen_native.models.common.resolution.actions import ConfigAction, Rule
...
class ConfigResolution:
    ...
    def resolve(model_name: str, base_model: str | None = None) -> "ModelConfig":
        from sdmlx_qwen_native.models.common.config.model_config import AVAILABLE_MODELS, ModelConfig
        from sdmlx_qwen_native.utils.exceptions import InvalidBaseModel, ModelConfigError
