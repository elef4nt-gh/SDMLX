...
from .comfy_aura_simple_scheduler import ComfyAuraSimpleScheduler
from .seedvr2_euler_scheduler import SeedVR2EulerScheduler

__all__ = [
    "LinearScheduler",
    "FlowMatchEulerDiscreteScheduler",
    "ComfyAuraSimpleScheduler",
...
SCHEDULER_REGISTRY = {
    ...
    "comfy_aura_simple": ComfyAuraSimpleScheduler,
    "ComfyAuraSimpleScheduler": ComfyAuraSimpleScheduler,
...
def try_import_external_scheduler(scheduler_object_path: str):
    ...
    if not issubclass(SchedulerClass, BaseScheduler):
        raise InvalidSchedulerType(
            ...
            f"All schedulers must inherit from sdmlx_qwen_native.models.common.schedulers.BaseScheduler."
        )
