...
from sdmlx_qwen_native.models.common.tokenizer.tokenizer_output import TokenizerOutput
...
class LanguageTokenizer(BaseTokenizer):
    ...
    def tokenize(
        ...
        **kwargs,
        ...
        if all(p == "" for p in prompts) and not (self.template or self.use_chat_template):
