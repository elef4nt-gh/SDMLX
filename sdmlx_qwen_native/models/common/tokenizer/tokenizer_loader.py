...
from sdmlx_qwen_native.models.common.tokenizer.tokenizer import (
    BaseTokenizer,
    LanguageTokenizer,
...
if TYPE_CHECKING:
    from sdmlx_qwen_native.models.common.weights.loading.weight_definition import TokenizerDefinition
