...
from sdmlx_qwen_native.models.qwen.model.qwen_text_encoder.qwen_encoder import QwenEncoder
...
class QwenVisionLanguageEncoder(nn.Module):
    ...
    def __call__(
        ...
        template_drop_idx: int | None = None,
        ...
        drop_idx = self.edit_template_start_idx if template_drop_idx is None else max(0, int(template_drop_idx))
