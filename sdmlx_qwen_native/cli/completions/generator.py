...
from sdmlx_qwen_native.cli.defaults import defaults as ui_defaults
from sdmlx_qwen_native.cli.parser.parsers import CommandLineParser
from sdmlx_qwen_native.models.flux.variants.in_context.utils.in_context_loras import LORA_NAME_MAP


class CompletionGenerator:
    def __init__(self):
        self.commands = [
            "sdmlx_qwen_native-generate",
            "sdmlx_qwen_native-generate-flux2",
            "sdmlx_qwen_native-generate-flux2-edit",
            "sdmlx_qwen_native-generate-controlnet",
            "sdmlx_qwen_native-generate-kontext",
            "sdmlx_qwen_native-generate-in-context",
            "sdmlx_qwen_native-generate-in-context-edit",
            "sdmlx_qwen_native-generate-in-context-catvton",
            "sdmlx_qwen_native-generate-fill",
            "sdmlx_qwen_native-generate-depth",
            "sdmlx_qwen_native-generate-redux",
            "sdmlx_qwen_native-generate-qwen",
            "sdmlx_qwen_native-generate-qwen-edit",
            "sdmlx_qwen_native-generate-fibo",
            "sdmlx_qwen_native-generate-fibo-edit",
            "sdmlx_qwen_native-generate-z-image",
            "sdmlx_qwen_native-generate-z-image-turbo",
            "sdmlx_qwen_native-refine-fibo",
            "sdmlx_qwen_native-inspire-fibo",
            "sdmlx_qwen_native-concept",
            "sdmlx_qwen_native-concept-from-image",
            "sdmlx_qwen_native-save",
            "sdmlx_qwen_native-save-depth",
            "sdmlx_qwen_native-train",
            "sdmlx_qwen_native-upscale-controlnet",
            "sdmlx_qwen_native-upscale-seedvr2",
            "sdmlx_qwen_native-lora-library",
            "sdmlx_qwen_native-info",
            "sdmlx_qwen_native-completions",
        ]

    def create_parser_for_command(self, command: str) -> CommandLineParser:
        parser = CommandLineParser(prog=command, add_help=False)

        if command == "sdmlx_qwen_native-generate":
        ...
        elif command == "sdmlx_qwen_native-generate-flux2":
            parser.add_general_arguments()
            parser.add_model_arguments(require_model_arg=False)
            parser.add_lora_arguments()
            parser.add_image_generator_arguments(supports_metadata_config=True, supports_dimension_scale_factor=True)
        ...
        elif command == "sdmlx_qwen_native-generate-flux2-edit":
            parser.add_general_arguments()
            parser.add_model_arguments(require_model_arg=False)
            parser.add_lora_arguments()
            parser.add_argument(
        ...
        elif command == "sdmlx_qwen_native-generate-controlnet":
            parser.add_general_arguments()
        ...
        elif command == "sdmlx_qwen_native-generate-kontext":
            parser.add_general_arguments()
            parser.add_model_arguments(require_model_arg=False)
            parser.add_lora_arguments()
            parser.add_image_generator_arguments(supports_metadata_config=True, supports_dimension_scale_factor=True)
        ...
        elif command == "sdmlx_qwen_native-generate-in-context":
            parser.add_general_arguments()
            parser.add_model_arguments(require_model_arg=False)
            parser.add_image_generator_arguments()
            parser.add_image_to_image_arguments(required=True)
        ...
        elif command == "sdmlx_qwen_native-generate-in-context-edit":
            parser.add_general_arguments()
            parser.add_model_arguments(require_model_arg=False)
            parser.add_lora_arguments()
        ...
        elif command == "sdmlx_qwen_native-generate-in-context-catvton":
            parser.add_general_arguments()
            parser.add_model_arguments(require_model_arg=False)
            parser.add_lora_arguments()
            parser.add_image_generator_arguments(supports_metadata_config=False, require_prompt=False)
        ...
        elif command == "sdmlx_qwen_native-generate-fill":
            parser.add_general_arguments()
            parser.add_model_arguments(require_model_arg=False)
            parser.add_lora_arguments()
            parser.add_image_generator_arguments()
        ...
        elif command == "sdmlx_qwen_native-generate-depth":
            parser.add_general_arguments()
            parser.add_model_arguments(require_model_arg=False)
            parser.add_lora_arguments()
            parser.add_image_generator_arguments()
        ...
        elif command == "sdmlx_qwen_native-generate-redux":
            parser.add_general_arguments()
            parser.add_model_arguments(require_model_arg=False)
            parser.add_lora_arguments()
            parser.add_image_generator_arguments()
        ...
        elif command == "sdmlx_qwen_native-generate-qwen":
            parser.add_general_arguments()
            parser.add_model_arguments(require_model_arg=False)
            parser.add_lora_arguments()
        ...
        elif command == "sdmlx_qwen_native-generate-qwen-edit":
            parser.add_general_arguments()
            parser.add_model_arguments(require_model_arg=False)
            parser.add_lora_arguments()
            parser.add_image_generator_arguments(supports_metadata_config=True)
        ...
        elif command == "sdmlx_qwen_native-generate-fibo":
            parser.add_general_arguments()
            parser.add_model_arguments(require_model_arg=False)
            parser.add_lora_arguments()
            parser.add_image_generator_arguments(supports_metadata_config=True)
        ...
        elif command == "sdmlx_qwen_native-generate-fibo-edit":
            parser.add_general_arguments()
            parser.add_model_arguments(require_model_arg=False)
        ...
        elif command == "sdmlx_qwen_native-generate-z-image-turbo":
            parser.add_general_arguments()
            parser.add_model_arguments(require_model_arg=False)
            parser.add_lora_arguments()
            parser.add_image_generator_arguments(supports_metadata_config=True)
        ...
        elif command == "sdmlx_qwen_native-refine-fibo":
        ...
        elif command == "sdmlx_qwen_native-inspire-fibo":
        ...
        elif command == "sdmlx_qwen_native-concept":
            parser.add_general_arguments()
            parser.add_model_arguments(require_model_arg=True)
        ...
        elif command == "sdmlx_qwen_native-concept-from-image":
            parser.add_general_arguments()
            parser.add_model_arguments(require_model_arg=True)
        ...
        elif command == "sdmlx_qwen_native-save":
            parser.add_model_arguments(path_type="save", require_model_arg=True)

        elif command == "sdmlx_qwen_native-save-depth":
            parser.add_save_depth_arguments()
            parser.add_output_arguments()

        elif command == "sdmlx_qwen_native-train":
            parser.add_model_arguments(require_model_arg=False)
            parser.add_training_arguments()

        elif command == "sdmlx_qwen_native-upscale-controlnet":
            parser.add_general_arguments()
            parser.add_model_arguments(require_model_arg=False)
            parser.add_lora_arguments()
            parser.add_lora_arguments()
        ...
        elif command == "sdmlx_qwen_native-upscale-seedvr2":
            parser.add_general_arguments()
            parser.add_seedvr2_upscale_arguments()
            parser.add_output_arguments()

        elif command == "sdmlx_qwen_native-lora-library":
        ...
        elif command == "sdmlx_qwen_native-info":
            parser.add_info_arguments()

        elif command == "sdmlx_qwen_native-completions":
...
# ZSH completion for sdmlx_qwen_native commands
# Generated by sdmlx_qwen_native-completions
