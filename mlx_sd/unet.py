...
class UNetModel(nn.Module):
    ...
    def __call__(
        ...
        encoder_attn_mask=None,
        text_time=None,
        control_down_residuals=None,
        control_mid_residual=None,
    ):
        ...
        if control_down_residuals is not None:
            residuals = [
                residual + control.astype(residual.dtype)
                for residual, control in zip(residuals, control_down_residuals)
            ]
        ...
        if control_mid_residual is not None:
            x = x + control_mid_residual.astype(x.dtype)
